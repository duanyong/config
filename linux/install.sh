...
#
sudo apt-get install -y git mysql-server mysql-client php5 php5-cli php5-cgi php5-fpm php5-curl php5-mysql php5-memcache php-apc php-pear nginx ssh openssh-server openssh-client tree samba smbfs language-pack-zh-hans language-pack-zh-hant vim meld cscope exuberant-ctags php-http-request pmtools



#pman
sudo pear channel-update doc.php.net
sudo pear install -y doc.php.net/pman
pear install -y MDB2_Driver_mysql-1.5.0b3
...
#多媒体功能
#sudo apt-get install -y medibuntu
